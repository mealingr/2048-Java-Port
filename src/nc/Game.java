...
public final class Game
{
    ...
    public static final void addRandomTile(final Random random,
                                           final int[][] grid,
                                           final double probabilityOfTwo)
    {
    ...
    public static final int move(final int[][] grid,
                                 final int direction)
    {
        switch (direction)
        {
    ...
    public static final boolean hasWon(final int[][] grid,
                                       final int winningTile)
    {
        for (int row = 0; row < grid.length; row++)
        {
    ...
    public static final boolean hasEqualNeighbour(final int[][] grid,
                                                  final int row,
                                                  final int column)
    {
